      ...
      TextureMap (char * filename)
        {
          ...
          glTexEnvf (GL_TEXTURE_ENV, GL_TEXTURE_ENV_MODE, GL_MODULATE); //GL_DECAL //Modular?
...
class OpenGLPaintableWidget : public QGLWidget
  {
    ...
    public:
      ...
      OpenGLPaintableWidget (Mesh * terr, Mesh * tru, Mesh * bu, Mesh * boat, Mesh * spine, Mesh * canyon, Mesh * warp,QWidget *parent, const char *name) : QGLWidget (parent, name)
        {
          terrain = terr;
	  trunk = tru;
	  bug = bu;
	  ...
	  terrain4 = warp;
          ...
          //string curvedefn ("11 [ {-100.0,16.0,-45.0} {-20.0,18.0,-45.0}{-20.0,18.0,-45.0}{-20.0,18.0,-45.0}{-20.0,18.0,-45.0}{20.0,-40.0,-40.0} {-60.0,50.0,-60.0} {+60.0,-99.8,-60.0} {+60.0,-5.8,+60.0} {-60.0,2.8,+60.0} {-60.0,2.8,-60.0} ]");
	  ...
	  //string curvedefn ("8 [ {37.0,12.0,37.0} {-37.0,12.0,37.0}{-37.0,12.0,-37.0}{37.0,12.0,-37.0}{37.0,12.0,37.0}{37.0,12.0,37.0}{37.0,12.0,60.0}{37.0,12.0,60.0}]");
	  //string curvedefn ("10 [ {0,2000,0} {-20.0,100,-20.0} {+30.0,15,-30.0} {+30.0,15,+30.0} {-30.0,15,+30.0} {-30.0,15,-10.0} {+30.0,15,-30.0} {+30.0,15,+30.0} {-30.0,15,+10.0} {-30.0,15,-10.0} ]");
	  //string curvedefn ("5 [{-30,20,-30}{-30,20,30}{30,20,30}{30,20,-30}{-30,20,-30}]");
...
//          trunk->renderNormals ();
	  ...
	  for (int i = 0; i < n; i++)
	    {
	      glPushMatrix ();
	      // rotate bent branch around parent.9
	  ...
	  //glBlendFunc (GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA);
	     ...
	     //My rollercoaster has the form of a boat : 02zwtc06 from the object library
	     //coaster
	     
	     /*
	     glPushMatrix ();
	     glTranslatef (0.0, -1.6, 2);
	     glScalef(0.02,0.02,0.02);    
	     coaster->render();
	     //glTranslatef (0.0, 150, -150);
	     glPopMatrix ();
	     */
	     ...
	     */
	      //GLUquadricObj* test = new GLUquadricObj*
	      //gluCylinder();
	      //gluCylinder(rails,0.5,0.5,100,32,32);
	      //camerapath->render();
	  glTranslatef (0.0, -2.0, 0.0);
	  //lTranslatef (0.0, 0.0, -0.1);
...

{
  ...
  Mesh * m4 = new Mesh ("02zwtc06");  
  Mesh * m5 = new Mesh ("spiny");
  Mesh * m6 = new Mesh ("spiny2");
  Mesh * m7 = new Mesh ("spiny3");
         
  OpenGLPaintableWidget w (m1, m2, m3, m4, m5, m6, m7, NULL, "canvas");
  w.show();
